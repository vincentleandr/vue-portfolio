<template>
    <div class="main-content d-flex d-flex--col animated fadeIn">
        <parallax-container :class="['about-page d-flex j-sp-between', {'d-flex--col' : window.width <= 1024}]">
            <parallax-element class="about-page__section--fw d-flex d-flex--col" :parallaxStrength="-15" :type="'translation'" v-if="window.width <= 1024">
                <img class="about-page__img" src="../assets/images/self-pic-1.jpg" alt="Who I Am">
            </parallax-element>
            
            <div :class="['about-page__section d-flex d-flex--col', {'about-page__section--fw' : window.width <= 1024}]">
            ...
            <parallax-element class="about-page__section d-flex d-flex--col" :parallaxStrength="-15" :type="'translation'" v-if="window.width > 1024">
                <img class="about-page__img" src="../assets/images/self-pic-1.jpg" alt="Who I Am">
            </parallax-element>
        </parallax-container>

        <parallax-container :class="['about-page d-flex j-sp-between', {'d-flex--col' : window.width <= 1024}]">
            <parallax-element :class="['about-page__section d-flex d-flex--col', {'about-page__section--fw' : window.width <= 1024}]" :parallaxStrength="-15" :type="'translation'">
